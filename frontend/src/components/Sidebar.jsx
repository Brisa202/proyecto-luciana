...
import {
  Home, Users, Boxes, Truck, FileText, LogOut, ShieldCheck,
  User as UserIcon, AlertTriangle, Contact // 👈 icono para Clientes
} from 'lucide-react';
  ...
  return (
    <aside className="sidebar">
      ...
      <nav className="sb-nav">
        ...
        <Item to="/clientes"   icon={Contact}       label="Clientes" />   {/* 👈 NUEVO */}
